...
final class Events
{
    public const ADMIN_NOTIFICATION_NOTICE = 'AdminNotification.notice';
    ...
    public const CORE_ADMIN_HOME_INVALIDATE_ARCHIVED_REPORTS = 'API.CoreAdminHome.invalidateArchivedReports.end';
    ...
    public const GROUP_PERMISSIONS_ADD_USER_TO_GROUP = 'API.GroupPermissions.addUserToGroup.end';
    public const GROUP_PERMISSIONS_CREATE_GROUP = 'API.GroupPermissions.createGroup.end';
    public const GROUP_PERMISSIONS_REMOVE_USER_FROM_GROUP = 'API.GroupPermissions.removeUserFromGroup.end';
    public const GROUP_PERMISSIONS_RENAME_GROUP = 'API.GroupPermissions.renameGroup.end';
    public const GROUP_PERMISSIONS_DELETE_GROUP = 'API.GroupPermissions.deleteGroup.end';
    public const GROUP_PERMISSIONS_SET_GROUP_ACCESS = 'API.GroupPermissions.setGroupAccess.end';
    ...
    public const PRIVACY_MANAGER_SET_SCHEDULE_REPORT_DELETION_SETTINGS = 'API.PrivacyManager.setScheduleReportDeletionSettings.end';
    ...
    public const SYSTEM_SETTINGS_UPDATED = 'SystemSettings.updated';
