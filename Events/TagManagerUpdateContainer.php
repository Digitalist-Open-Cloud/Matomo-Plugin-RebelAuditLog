...
class TagManagerUpdateContainer extends AbstractEventHandler
{
    public static function getSubscribedEvents(): array
    {
        return [Events::TAG_MANAGER_UPDATE_CONTAINER];
    }

    public function __invoke(...$params): void
    {
        $details = $this->utility->extractEventDetails($params[1]);
        $log = "Updated container {$details['params']['name']} for site id {$details['params']['idSite']}.";
