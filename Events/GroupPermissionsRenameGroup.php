...
class GroupPermissionsRenameGroup extends AbstractEventHandler
{
    public static function getSubscribedEvents(): array
    {
        return [Events::GROUP_PERMISSIONS_RENAME_GROUP];
    }
    ...
    public function __invoke(...$params): void
    {
        ...
        $log = "Group with id {$detailedLog['idGroup']} renamed to {$detailedLog['newName']}.";
