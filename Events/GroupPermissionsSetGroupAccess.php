...
class GroupPermissionsSetGroupAccess extends AbstractEventHandler
{
    public static function getSubscribedEvents(): array
    {
        return [Events::GROUP_PERMISSIONS_SET_GROUP_ACCESS];
    }
    ...
    public function __invoke(...$params): void
    {
        ...
        $log = "Set group {$detailedLog['name']} to access {$detailedLog['access']} for sites {$detailedLog['idSites']}.";
