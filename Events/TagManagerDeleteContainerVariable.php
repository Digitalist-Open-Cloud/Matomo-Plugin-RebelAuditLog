...
class TagManagerDeleteContainerVariable extends AbstractEventHandler
{
    public static function getSubscribedEvents(): array
    {
        return [Events::TAG_MANAGER_DELETE_CONTAINER_VARIABLE];
    }

    public function __invoke(...$params): void
    {
        $details = $this->utility->extractEventDetails($params[1]);
        $log = "Deleted container variable ({$details['params']['idVariable']}) for container id {$details['params']['idContainer']} for site id {$details['params']['idSite']}.";
