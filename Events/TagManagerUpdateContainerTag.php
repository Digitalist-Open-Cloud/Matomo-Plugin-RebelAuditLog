...
class TagManagerUpdateContainerTag extends AbstractEventHandler
{
    public static function getSubscribedEvents(): array
    {
        return [Events::TAG_MANAGER_UPDATE_CONTAINER_TAG];
    }

    public function __invoke(...$params): void
    {
        $details = $this->utility->extractEventDetails($params[1]);
        $log = "Updated container tag {$details['params']['name']} ({$details['params']['idTag']}) for site id {$details['params']['idSite']}.";
