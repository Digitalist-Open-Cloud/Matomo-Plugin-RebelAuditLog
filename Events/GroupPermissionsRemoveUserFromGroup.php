...
class GroupPermissionsRemoveUserFromGroup extends AbstractEventHandler
{
    public static function getSubscribedEvents(): array
    {
        return [Events::GROUP_PERMISSIONS_REMOVE_USER_FROM_GROUP];
    }
    ...
    public function __invoke(...$params): void
    {
        ...
        $log = "User {$detailedLog['login']} removed from group with id {$detailedLog['idGroup']}.";
