...
class GroupPermissionsDeleteGroup extends AbstractEventHandler
{
    public static function getSubscribedEvents(): array
    {
        return [Events::GROUP_PERMISSIONS_DELETE_GROUP];
    }
    ...
    public function __invoke(...$params): void
    {
        ...
        $log = "Group with id {$detailedLog['idGroup']} deleted.";
