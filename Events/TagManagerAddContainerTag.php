...
class TagManagerAddContainerTag extends AbstractEventHandler
{
    public static function getSubscribedEvents(): array
    {
        return [Events::TAG_MANAGER_ADD_CONTAINER_TAG];
    }

    public function __invoke(...$params): void
    {
        $details = $this->utility->extractEventDetails($params[1]);
        $log = "Added container tag {$details['params']['name']} for site id {$details['params']['idSite']}.";
