...
class TagManagerUpdateContainerVariable extends AbstractEventHandler
{
    public static function getSubscribedEvents(): array
    {
        return [Events::TAG_MANAGER_UPDATE_CONTAINER_VARIABLE];
    }
    ...
    public function __invoke(...$params): void
    {
        ...
        $log = "Updated container variable {$name} for site id {$details['params']['idSite']}.";
