...
class TagManagerUpdateContainerTrigger extends AbstractEventHandler
{
    public static function getSubscribedEvents(): array
    {
        return [Events::TAG_MANAGER_UPDATE_CONTAINER_TRIGGER];
    }

    public function __invoke(...$params): void
    {
        $details = $this->utility->extractEventDetails($params[1]);
        $log = "Updated container trigger {$details['params']['name']} for container with id {$details['params']['idContainer']} for site id {$details['params']['idSite']}.";
