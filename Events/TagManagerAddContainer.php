...
class TagManagerAddContainer extends AbstractEventHandler
{
    public static function getSubscribedEvents(): array
    {
        return [Events::TAG_MANAGER_ADD_CONTAINER];
    }

    public function __invoke(...$params): void
    {
        $details = $this->utility->extractEventDetails($params[1]);
        $log = "Added Tag manager container {$details['params']['name']} for site id {$details['params']['idSite']}.";
