...
class AnnotationsSave extends AbstractEventHandler
{
    public static function getSubscribedEvents(): array
    {
        return [Events::ANNOTATIONS_SAVE];
    }

    public function __invoke(...$params): void
    {
        $details = $this->utility->extractEventDetails($params[1]);
        $log = "Saved changes for annotation {$details['params']['note']} for site id {$details['params']['idSite']}.";
