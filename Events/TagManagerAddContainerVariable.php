...
class TagManagerAddContainerVariable extends AbstractEventHandler
{
    public static function getSubscribedEvents(): array
    {
        return [Events::TAG_MANAGER_ADD_CONTAINER_VARIABLE];
    }
    ...
    public function __invoke(...$params): void
    {
        ...
        $name = urldecode($details['params']['name']);
        $log = "Added container variable {$name} of type {$details['params']['type']} for site id {$details['params']['idSite']}.";
