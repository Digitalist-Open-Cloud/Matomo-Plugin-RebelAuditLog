...
class AnnotationsAdd extends AbstractEventHandler
{
    public static function getSubscribedEvents(): array
    {
        return [Events::ANNOTATIONS_ADD];
    }

    public function __invoke(...$params): void
    {
        $details = $this->utility->extractEventDetails($params[1]);
        $log = "Added annotation {$details['params']['note']} for site id {$details['params']['idSite']}.";
