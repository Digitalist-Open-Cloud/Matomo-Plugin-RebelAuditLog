...
class TagManagerDeleteContainer extends AbstractEventHandler
{
    public static function getSubscribedEvents(): array
    {
        return [Events::TAG_MANAGER_DELETE_CONTAINER];
    }

    public function __invoke(...$params): void
    {
        $details = $this->utility->extractEventDetails($params[1]);
        $log = "Deleted container with id {$details['params']['idContainer']} for site id {$details['params']['idSite']}.";
