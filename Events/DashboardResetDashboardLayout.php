...
class DashboardResetDashboardLayout extends AbstractEventHandler
{
    public static function getSubscribedEvents(): array
    {
        return [Events::DASHBOARD_RESET_LAYOUT];
    }
    ...
    public function __invoke(...$params): void
    {
        ...
        $log = "Layout was reset for dashboard with id {$details['params']['idDashboard']}.";
