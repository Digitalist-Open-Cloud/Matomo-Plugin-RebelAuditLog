...
class TagManagerPauseContainerTag extends AbstractEventHandler
{
    public static function getSubscribedEvents(): array
    {
        return [Events::TAG_MANAGER_PAUSE_CONTAINER_TAG];
    }

    public function __invoke(...$params): void
    {
        $details = $this->utility->extractEventDetails($params[1]);
        $log = "Paused container tag ({$details['params']['idTag']}) for site id {$details['params']['idSite']}.";
