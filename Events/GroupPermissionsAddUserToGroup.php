...
class GroupPermissionsAddUserToGroup extends AbstractEventHandler
{
    public static function getSubscribedEvents(): array
    {
        return [Events::GROUP_PERMISSIONS_ADD_USER_TO_GROUP];
    }
    ...
    public function __invoke(...$params): void
    {
        ...
        $log = "User {$detailedLog['login']} added to group with id {$detailedLog['idGroup']}.";
