...
class TagManagerExportContainerVersion extends AbstractEventHandler
{
    public static function getSubscribedEvents(): array
    {
        return [Events::TAG_MANAGER_EXPORT_CONTAINER_VERSION];
    }

    public function __invoke(...$params): void
    {
        $details = $this->utility->extractEventDetails($params[1]);
        $log = "A container version was exported for container id {$details['params']['idContainer']} for site id {$details['params']['idSite']}.";
