...
class TagManagerDeleteContainerTag extends AbstractEventHandler
{
    public static function getSubscribedEvents(): array
    {
        return [Events::TAG_MANAGER_DELETE_CONTAINER_TAG];
    }

    public function __invoke(...$params): void
    {
        $details = $this->utility->extractEventDetails($params[1]);
        $log = "Deleted container tag ({$details['params']['idTag']}) for container with id {$details['params']['idContainer']} for site id {$details['params']['idSite']}.";
