...
class TagManagerResumeContainerTag extends AbstractEventHandler
{
    public static function getSubscribedEvents(): array
    {
        return [Events::TAG_MANAGER_RESUME_CONTAINER_TAG];
    }

    public function __invoke(...$params): void
    {
        $details = $this->utility->extractEventDetails($params[1]);
        $log = "Resumed container tag ({$details['params']['idTag']}) for site id {$details['params']['idSite']}.";
