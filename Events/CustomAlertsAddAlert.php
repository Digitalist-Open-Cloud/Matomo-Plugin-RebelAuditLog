...
class CustomAlertsAddAlert extends AbstractEventHandler
{
    public static function getSubscribedEvents(): array
    {
        return [Events::CUSTOM_ALERTS_ADDED_ALERT];
    }
    ...
    public function __invoke(...$params): void
    {
        ...
        $log = "Added custom alert {$details['params']['name']} for site(s) {$siteIds}.";
