...
class TagManagerAddContainerTrigger extends AbstractEventHandler
{
    public static function getSubscribedEvents(): array
    {
        return [Events::TAG_MANAGER_ADD_CONTAINER_TRIGGER];
    }

    public function __invoke(...$params): void
    {
        $details = $this->utility->extractEventDetails($params[1]);
        $log = "Added container trigger {$details['params']['name']} of type {$details['params']['type']} for site id {$details['params']['idSite']}.";
