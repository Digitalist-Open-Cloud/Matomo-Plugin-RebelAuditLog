...
class TagManagerUpdateContainerVersion extends AbstractEventHandler
{
    public static function getSubscribedEvents(): array
    {
        return [Events::TAG_MANAGER_UPDATE_CONTAINER_VERSION];
    }

    public function __invoke(...$params): void
    {
        $details = $this->utility->extractEventDetails($params[1]);
        $log = "A container version was updated for container id {$details['params']['idContainer']} for site id {$details['params']['idSite']}.";
